...
CREATE UNIQUE INDEX IF NOT EXISTS 'name_ind' ON 'realms' ('name');
...
CREATE UNIQUE INDEX IF NOT EXISTS 'code_ind' ON 'logins' ('code');
CREATE UNIQUE INDEX IF NOT EXISTS 'token_ind' ON 'logins' ('refresh_token');
